...
filenames=os.listdir(r'C:\Users\Harbiodun\Documents\Data Science and AI\Deep Learning\venv\Files\datasets\dog vs cat\dataset\training_set')
print(filenames) # ****************
categories=[]
...
print('manage dataframe: \n', df) # ****************

train_df,validate_df = train_test_split(df,test_size=0.20,
  random_state=42)
print('manage train_df: \n', train_df) # ****************
print('manage validate_df: \n', validate_df) # ****************
